     ...
     <div class="row" id="imageDiv">
            ...
            <div class="panel panel-default" ng-controller="registerController">
              <form name="registerForm" ng-submit="saveCustomer(registerForm)" novalidate>
                <div class="panel-heading"> <strong class="">Request for free demo</strong>
                </div>
                <div class="panel-body">
	         		 <div class="row">
						...
						<div class="alert alert-success alert-dismissable"
							...
							style="display: none; height: 47px; white-space: nowrap;">
							<!-- <button type="button" class="close" >x</button> -->
							<strong>Success! </strong> Thank you for expressing interest in PM Platform. 
				...
				<div class="panel-footer">
					<div class="row">
					<div class="col-sm-12">
				    <input  type="submit" class="btn btn-md btn-info pull-left" ng-disabled="registerForm.$invalid" value="SUBMIT"/>	
