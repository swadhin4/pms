...
<script type="text/javascript" 	src='<c:url value="/resources/theme1/js/password-service.js"></c:url>'></script>
<style>
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
     ...
     <div class="row" id="imageDiv">
            ...
            <div class="panel panel-default" ng-controller="passwordController">
              <form name="passwordResetForm" ng-submit="resetCustomerNewPassword(passwordResetForm)" novalidate>
                <div class="panel-heading"> <strong class="">Congratulations!! ${user} Now you can easily create your password</strong>
                </div>
                <div class="panel-body">
	         		 <div class="row">
							<div class="col-sm-12 form-group">
								<label><i class="fa fa-envelope" aria-hidden="true"></i> New Password</label>
								 <span style="color:red" ng-show="passwordResetForm.newpassword.$error.minlength" class="errorMsg pull-right">
								 <i
						class="fa fa-exclamation-triangle" aria-hidden="true"></i>
						Please enter your new password
					</span>
								<input type="password" ng-model="customer.newPassword" ng-minlength="6"
								name="newPassword" placeholder="Enter new password here.." class="form-control" required>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12 form-group">
								...
								<span ng-show="passwordResetForm.confpassword.$invalid && !passwordResetForm.confpassword.$pristine"	
								class="errorMsg pull-right"> <i
						class="fa fa-exclamation-triangle" aria-hidden="true"></i>
						Please confirm your new password
					</span>
								<input type="password"	ng-model="customer.confirmPassword" 
                      data-valid-password-c="{{customer.newPassword === customer.confirmPassword}}"
								name="confpassword" placeholder="Confirm your password here.." class="form-control" required>
							</div>
						</div>
						<div class="alert alert-success alert-dismissable"
							...
							<strong>Success! </strong> A mail with a link has been sent to reset your password. 
				...
				<div class="panel-footer">
					<div class="row">
					<div class="col-sm-12">
				    <input  type="submit" class="btn btn-md btn-info pull-left" ng-disabled="passwordResetForm.$invalid" value="SUBMIT"/>	
					<input type="reset" class="btn btn-md btn-default pull-left"	id="paswordResetFormBtn" value="RESET"/>
					</div>
					</div>
			</div>
									</form>
