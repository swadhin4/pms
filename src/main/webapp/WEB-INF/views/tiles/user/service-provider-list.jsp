								...
								<div class="row">
									 ...
									 <div class="col-md-12">
										...
										<table class="table no-margin">
											...
											<tr><td style="width:40%"><b>Company Email</b></td><td>{{selectedServiceProvider.email}}</td>
											</tr>
											<tr><td style="width:40%"><b>Help Desk Email</b></td><td>{{selectedServiceProvider.helpDeskEmail}}</td>
											</tr>
											<tr><td style="width:40%"><b>Help Desk number</b></td><td>{{selectedServiceProvider.helpDeskNumber}}</td>
											</tr>
											</thead>
											<tbody>											
