...
public class EmailServiceImpl implements EmailService {
	...
	@Override
	@Async
	public RestResponse successTicketCreationSPEmail(TicketVO savedticketVO, String creationStatus, String company) throws Exception {
		// Create a Properties object to contain connection configuration information.
		...
		/*	StringBuilder messageContent = new StringBuilder();
	        ...
	        model.put("siteIdNumber1", site.getSiteNumberOne()==null?"":site.getSiteNumberOne());
	        model.put("siteIdNumber2", site.getSiteNumberTwo()==null?"":site.getSiteNumberTwo());
	        model.put("contactName", site.getAreaManagerName()==null?"":site.getAreaManagerName());
	        model.put("contactEmail", site.getEmail()==null?"":site.getEmail());
	        ...
	        model.put("issueStartDate", savedticketVO.getTicketStartTime()==null?"":savedticketVO.getPriorityDescription());
	        model.put("resolutionDate", savedticketVO.getServiceRestorationTime()==null?"":savedticketVO.getServiceRestorationTime());
			...
			mbp1.setHeader("Content-Type","text/plain; charset=\"utf-8\""); 
			mbp1.setContent( getContentFromTemplate(model, "incident-create.txt"), "text/html; charset=utf-8" ); 
			mbp1.setHeader("Content-Transfer-Encoding", "quoted-printable");
