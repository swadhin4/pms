...
public class NumberToWord
{
	...
	public static void main(String[] args)
	{
		...
		String integerPart=textBD.substring(0, radixLoc);
		String fractionPart=textBD.substring(radixLoc + 1, textBD.length());
		System.out.println("Rupees:"+ obj.convertNumberToWords(Integer.parseInt(integerPart)) + " and "+Integer.parseInt(fractionPart) +" Paise");
